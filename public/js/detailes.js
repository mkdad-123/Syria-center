/* about-us.js — بلا كوكي لغة ولا ?lang= (منع وميض اللغة) */
(() => {
    "use strict";
    ...
    // مبدّل اللغة من القائمة .language-switcher
    ...
    // سلايد شو خلفية بسيطة (اعتمادًا على .background-slideshow img و .active في CSS)
