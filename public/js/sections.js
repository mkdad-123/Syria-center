/* about-us.js — تبديل لغة بلا كوكي/POST وبلا ?lang= */
(() => {
    "use strict";
    ...
    // ابني رابط بنفس المسار مع تبديل أول سيغمنت إلى ar|en
    ...
    // مبدّل اللغة من قائمة .language-switcher
    ...
    // سلايد شو الخلفية (اعتمادًا على .background-slideshow img و .active في CSS)
