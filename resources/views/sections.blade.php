...
<head>
    ...
    <!-- Inline Critical CSS (يمكن إضافته هنا إذا كان لديك) -->
    <style>
        /* يمكن إضافة أي أنماط حرجة هنا لتجنب وميض المحتوى غير المنسق */
        .logo-container, .header, .section-title {
            opacity: 0;
                            ...
                            <div class="section-image-container">
                                @if ($section['image'])
                                    <img src="{{ asset('storage/' . $section['image']) }}"
                                        alt="{{ $section['name'] }}" class="section-image" loading="lazy" width="300" height="200">
                                @else
                                    <img src="{{ asset('/default-section.jpg') }}"
                                        alt="{{ __('main.default_image') }}" class="section-image" loading="lazy" width="300" height="200">
                                @endif
                            </div>
